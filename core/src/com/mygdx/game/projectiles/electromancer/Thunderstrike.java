...
public class Thunderstrike extends StaticProjectile {
	 ...
	 */
	private Thunderstrike() { }

	public Thunderstrike(Entity entity, Vector3 pos, float lifetime, Entity targetEntity) {
...
//		spriteBatch.draw(getTexture(), 0, 0);
