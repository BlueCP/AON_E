...
public class SpiritSnareArea extends StaticProjectile {

	private static final int baseRootDuration = 2;
	...
	public boolean onHitEntity(Entity entity, PlayScreen playScreen) {
		...
		if (entity.id != owner) {
			...
			entity.rootedEffect.add(baseRootDuration + offender.soulsEffect.numStacks());
			return true;
		} else {
			return false;
		}
