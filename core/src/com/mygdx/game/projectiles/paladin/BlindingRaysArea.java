...
public class BlindingRaysArea extends StaticProjectile {

	private static final float blindPower = 0.5f;
	private static final float blindDuration = 5;
	...
	public boolean onHitEntity(Entity entity, PlayScreen playScreen) {
		...
		if (entity.id != owner) {
			...
			entity.blindedEffect.add(blindPower, blindDuration);
			return true;
		} else {
			return false;
		}
