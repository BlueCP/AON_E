...
public class ControllableObject extends ConstantObject {

	public ControllableObject(btCollisionObject collisionObject, TextureRegion[] texture, String id, Array<Tag> tags,
							  int spriteX, int spriteY) {
		super(collisionObject, texture, id, tags, spriteX, spriteY);
		int physicsId = Util.getPhysicsId(Integer.parseInt(id), "3100");
