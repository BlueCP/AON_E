 ...
 * The 'disc' at the end is short for discrete; values for power are integers; they take fixed values (like status
 * effects in Minecraft).
 */
public class ProcEffectDisc extends Effect {
	 ...
	 */
	public int add(int power, float duration) {
		powers.add(power);
	 ...
	 */
	public int addThisTick(int power) {
		powers.add(power);
		durations.add(0f);
		return generateId();
	}
